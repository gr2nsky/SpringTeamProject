...
<link rel="stylesheet" href="/ysms/resources/css/review.css" type="text/css">
<title>내가 쓴 리뷰</title>
</head>
	...
	<table id="detailReview" align="center">
		...
		<tr>
			<td class="photo" colspan="5" align="center">
				<div class="review">
				<img class="reviewPhoto" src="${pageContext.request.contextPath }/resources/${detailViewReview.reviewFilePath }">
				</div>
			</td>
		</tr>
		</c:if>
