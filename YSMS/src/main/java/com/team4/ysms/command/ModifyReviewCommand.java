...
public class ModifyReviewCommand implements SCommand {
	...
	public void execute(SqlSession sqlSession, Model model, HttpSession httpSession) {
        ...
        if(fileSize != 0) {
        	...
        	dbInsertImgName = mtfRequest.getParameter("reviewOldFilePath");
        }
		
        dao.myInfoReviewModifyDao(mtfRequest.getParameter("reviewContent"), 
