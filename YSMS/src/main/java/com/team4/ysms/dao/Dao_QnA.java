...
import com.team4.ysms.dto.Dto_QnA;
	...
	/* 
	 	-----------------------------
	 	21.07.05 hyokyeong
	 	qna Dao change to interface
	 	-----------------------------
	 */
public interface Dao_QnA {
	
	// 전체 검색
	public ArrayList<Dto_QnA> qnaListDao(int place_no, int requestPage, int listCount);
	
	// 게시물 수 확인
	public Dto_Paging qnaListCountDao(int place_no);
	
	// qna작성
	public void qnaWriteDao(String content, String userid, String place_no);
	
//	// 입력
//	public void qnaWriteDao(String name, String filepath);
//	
//	// 상세보기
//	public FileUploadDto detailDao(String id);
//	
//	// 수정
//	public void qnaModifyDao(String name, String filepath, String id);
